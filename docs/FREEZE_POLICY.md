# Freeze Policy (Draft/Observed Mode)

This repository is in Draft/Observed Mode. The public site content is frozen
unless explicitly authorized.

Allowed while frozen:
- Build fixes (e.g., TypeScript or lint errors).
- Security hardening and anti-phishing copy (no new features).
- Typos or clarity edits that do not change meaning.
